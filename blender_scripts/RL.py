...
def run_rl():
    ...
    parser.add_argument('-o', '--output', default='/home/sneha/uncertainty/Drone_RL/RL_exp/log/', help='Directory to save data to')
    ...
    parser.add_argument('--load_network_path', default='/home/sneha/uncertainty/Drone_RL/RL_exp/log/blender_env-run10-/qnet355.h5', help='the path to the trained mode file')
...
def run_eval():
    ...
    parser.add_argument('--load_network_path', default='/home/sneha/uncertainty/Drone_RL/RL_exp/log/', help='the path to the trained mode file')
    parser.add_argument('--net_mode', default='dqn', help='choose the mode of net, can be linear, dqn, duel')
    parser.add_argument('--max_episode_length', default = 1000, type=int, help = 'max length of each episode')
