...
def run_rl():
    ...
    parser.add_argument('-o', '--output', default='/home/varun/Drone_RL/Drone_RL/RL_exp/log/', help='Directory to save data to')
    ...
    parser.add_argument('--exploration_steps', default=2400, type=int, help='Number of steps over which the initial value of epsilon is linearly annealed to its final value')
    parser.add_argument('--num_samples', default=4000, type=int, help='Number of training samples from the environment in training')
    ...
    parser.add_argument('--replay_memory_size', default=4000, type=int, help='Number of replay memory the agent uses for training')
    parser.add_argument('--target_update_freq', default=50, type=int, help='The frequency with which the target network is updated')
    parser.add_argument('--train_freq', default=3, type=int, help='The frequency of actions wrt Q-network update')
    ...
    parser.add_argument('--monitor', default=True, action='store_true', help='record video')
